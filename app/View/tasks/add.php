<?php require_once (APPROOT . '/View/base/header.php'); ?>
    ...
    <div class="container">
        ...
        <div class="card">
            <form novalidate action="<?php echo URLROOT; ?>tasks/add" method="post">
                <div class="form-group">
                    <label for="taskTitle" class="form-label">عنوان</label>
                    <input name="title" type="text" class="form-control  <?php echo (!empty($data['title_error'])) ? 'is-invalid' : ''; ?>" id="taskTitle">
                    <div class="invalid-feedback"> <?php echo $data['title_error']; ?> </div>
                </div>

                <div class="form-group">
                    <label for="taskDescription" class="form-label">شرح کامل</label>
                    <textarea name="content" class="form-control <?php echo (!empty($data['content_error'])) ? 'is-invalid' : ''; ?>" id="taskDescription" rows="5"></textarea>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 25px 35px;">
                    ...
                    <div class="form-group">
                        ...
                        <input name="project_name" type="text" class="form-control  <?php echo (!empty($data['project_name_error'])) ? 'is-invalid' : ''; ?>" id="taskTitle">
                    ...
                    <div class="form-group">
                        ...
                        <input name="deadline" type="date" class="form-control <?php echo (!empty($data['deadline_error'])) ? 'is-invalid' : ''; ?>" id="taskDueDate">
